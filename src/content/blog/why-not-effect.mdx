...
Val Town's backend is a pretty complex application. We're running user code, proxying blob storage and other services, storing observability data, running intervals, and a lot more.
