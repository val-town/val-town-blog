...
description: Claude Projects but with backends
...
This is enough to generate a basic Hacker News clone with a backend and database:
...
We might get there sooner than I would have thought. We live in exciting times.
