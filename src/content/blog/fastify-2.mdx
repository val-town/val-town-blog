---
title: "Moving to fastify pt. 2: Docs, an SDK and AI tools"
description: |
...
The last time, I [wrote about how we were switching from express to fastify][last_post]
for Val Town’s REST API. To recap, Fastify gives us a way to strictly
...
Are you not entertained? How about [a new TypeScript SDK](https://github.com/val-town/sdk)?
