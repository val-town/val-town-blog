...
We're growing our team! We're [hiring engineers in NY](https://val-town.notion.site/Founding-Engineer-at-Val-Town-e6fa51bdb2974778a4669ccdcf50b146) who are passionate about democratizing programming.
...
The first version of logs were stored in our main Postgres database. The second version was stored in Cloudflare R2, which was more scalable, but trapped our data in blobs. This third version is stores your logs in ClickHouse, which makes the system faster, scalable, and paves the way for features to filter and search through your logs. Thanks [@nbbaier](https://www.val.town/u/nbbaier) for the request for [real-time logging](https://github.com/val-town/val-town-product/discussions/30)!
...
Thanks to [Alex](https://www.val.town/u/azirbel) and [Ross](https://www.val.town/u/rosshunter) from [Playbook](https://playbook.com/) for championing [this feature request](https://github.com/val-town/val-town-product/discussions/28)!
...
- [@deepfates](https://www.val.town/u/deepfates) wrote a guide on building [a face swapping app with Val Town, HTMX, and Replicate](https://replicate.com/guides/hypermedia-api)
