...
- We were already using [light-my-request](https://github.com/fastify/light-my-request) to test
  our express server, but this is built-in to fastify and developed
  under the fastify organization: testing routes with fastify is
  as easy as calling the server with `.inject()`.
