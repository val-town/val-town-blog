...
- Dan Philbin made [a bunch of vals to work with the campsite API](https://www.val.town/u/campsite) and [tweeted a video](https://x.com/DanPhilibin/status/1833619842303463748) about it
- Sarah Chieng made a [Slack notifier](https://x.com/SarahChieng/status/1833602967410528594) whenever you, your company, or topics of interest are mentioned on Twitter, Hacker News, and Reddit, powered by Browserbase
- Jonnie Hallman made a [Slack bot](https://x.com/destroytoday/status/1834408549549494302) that reminds designtown.nyc folks ofthe keypad code
- Guy Dupont [generates X slams Y memes](https://x.com/gvy_dvpont/status/1841818282719924430), autotweeted to Mastadon
- Steve upgraded his [twitter alert](https://www.val.town/v/stevekrouse/twitterAlert) that sends a notification when certain keywords are tweeted to use SocialData's API, which any Val Town Pro user can fork and get some free usage of
- Guy Dupont built a site to convert [Landscape Video -> Blurred Portrait](https://x.com/gvy_dvpont/status/1840894297698128246)
...
- Ash Ryan made a [chore app](https://x.com/stevekrouse/status/1836136881702031425) for his daughter
- Nathan Baschez made a [color app](https://x.com/stevekrouse/status/1836031718249083128) for his daughter
