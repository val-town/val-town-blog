...
1. Routes around a slow part of our stack (maybe more on this later)
...
We've introduced lockfiles in Val Town to enhance stability, security, and performance. When you save a val, a deno.lock file is generated, ensuring the same versions of dependencies are used in the future. This prevents issues caused by changing libraries and malicious dependencies, and improves performance by caching the dependency tree. It was also a huge performance win. Learn more in [our announcement post](/blog/lockfiles).

![Charts of requests to esm.town and worker initialization time decreasing](./lockfiles/metrics.png)

### 💸 We joined the OSS Pledge

We're excited to announce that we've joined the [OSS Pledge](https://osspledge.com/). We commit to donating at least $2k per year per full-time developer at Val Town to open-source. You can learn more in [our announcement post](/blog/oss). We donated have donated $9,600 so far in 2024. So far we donated to:
...
- Email handler vals can now receive attachments – thanks [danielrw7](https://github.com/danielrw7) for the [feature request](https://github.com/val-town/val-town-product/discussions/75) 🙏 (our most requested feature)
...
- [@jxnblk](https://val.town/u/jxnblk) rebuilt his [jxnblk.com](https://jxnblk.com/) on val town – it's awesome!
...
- [@isidentical](https://www.val.town/u/isidentical) built a [Flux Image Generator](https://www.val.town/v/isidentical/fluxImageGenerator) that generates images from user prompts using the fal.ai API
...
- [David Siegel](https://www.val.town/u/dvdsgl) shared a demo for [bulk importing data into a Glide table](https://www.val.town/v/dvdsgl/glideImportDemo)
...
https://x.com/stevekrouse/status/1831455530948444352
...
https://x.com/PerbhatK/status/1831860667604934904
https://x.com/charmaine_klee/status/1831525120294236222
