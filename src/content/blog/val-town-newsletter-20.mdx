...
- Email handler vals can now receive attachments – thanks [danielrw7](https://github.com/danielrw7) for the [feature request](https://github.com/val-town/val-town-product/discussions/75) 🙏
...
- [Go to a val's full-screen editor by pressing .](https://x.com/stevekrouse/status/1822023518793404828) (like on GitHub) - thanks [David Siegel](https://val.town/u/dvdsgl) for the suggestion 🙏
