...
We want to highlight one of the biggest Projects so far. Nate is building {/* [X](TODO), */} an app to help people get more insight from their journaling practice. The frontend of the app is simply Notion, and the backend is hosted on Val Town. Nate has a series of Cron vals that run throughout the day to pull your latest journal entries, get analysis from AI, and send the insights back into Notion and personalize reports.

{/* Todo: Screenshot of Nate's Project here */}

Before Projects, Nate had dozens of vals scattered across folders, and versioned separately. He was able to migrate them all into a single Val Town Project in about 30 minutes. {/* TODO: Quote from Nate here */}
