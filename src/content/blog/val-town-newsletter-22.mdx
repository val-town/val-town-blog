...
- [Dan](TODO), an engineer at [Campsite](https://campsite.com), wrote [How we prototype API integrations with Val Town](https://www.campsite.com/blog/how-we-prototype-integrations-with-val-town) – it's an excellent read about how they "speedrun prototypes of bots, features, and 3rd party integrations" ([tweet](https://x.com/DanPhilibin/status/1852052119521542552))
- [Max](TODO) built [Val Town Town](https://blog.val.town/blog/val-town-town/) – a clone of Val Town, built in Val Town! If you want to run your users' or AI-generated server-side JavaScript, now you can do that in Val Town by forking and customizing Val Town Town
...
- [Arti](https://www.val.town/u/artivilla) built a [Farcaster Keyword Alerter](https://www.val.town/v/artivilla/farcasterKeyHook), which sends Slack notifications when a keyword is mentioned on Farcaster, powered by [Neynar](https://neynar.com/)
...
- TODO pull more from folks who commented in Discord
- https://www.val.town/v/trob/prompt_to_code_auto_refresh_codebed
- https://www.val.town/v/JamesAndrew/tenaciousPlumWoodpecker
- https://vimeo.com/1029083124/fed022ab5
- TODO find discord thread and tell story on twitter, bluesky and link back to it on discord, and link to post here
- https://x.com/stevekrouse/status/185896999632577778
...
- https://www.val.town/v/loading/file
