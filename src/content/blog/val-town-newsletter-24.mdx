...
Thanks Robin Sloan, Matt Marcus, and Achille Lacoin for requesting this 🙏
...
Now, we surface those client-side errors right in every HTTP preview, so you can
see them right where you're working. To enable this, add this to your HTML:
...
- Fixed a bug that would very rarely run crons twice, thanks Nathaneal Silverman and Sean Piefayth for reporting this 🙏
